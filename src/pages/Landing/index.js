        ...
        <div id="page-landing">
             ...
             <div id="page-landing-content" className="container">
                <div className="logo-container">
                    ...
                    <span>
                        <p className="textDisplay">Deixe seu e-mail para avisarmos quando o site ficar pronto! Enquanto isso, entre em contato pelo email: <strong>getin@pollu-xtechnology.com</strong>.</p>
                    </span>
